...
public final class AppBarMainBinding implements ViewBinding {
  ...
  private AppBarMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull CoordinatorLayout contentView, @NonNull Toolbar toolbarMain) {
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      CoordinatorLayout contentView = (CoordinatorLayout) rootView;
      ...
      return new AppBarMainBinding((CoordinatorLayout) rootView, contentView, toolbarMain);
    }
