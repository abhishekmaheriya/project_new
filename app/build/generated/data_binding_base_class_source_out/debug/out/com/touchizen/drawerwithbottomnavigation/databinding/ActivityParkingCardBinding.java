...
public final class ActivityParkingCardBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityParkingCardBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityParkingCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityParkingCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_parking_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityParkingCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityParkingCardBinding((RelativeLayout) rootView, layoutmain, tabLayout,
